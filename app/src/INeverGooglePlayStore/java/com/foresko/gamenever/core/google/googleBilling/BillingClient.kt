package com.foresko.gamenever.core.google.googleBilling
...
class BillingClient(
    ...
    val productDetails: Flow<ProductDetails> =
        subscribeWithProductDetails.filter { it.containsKey(BASIC_SUB) }.map { it[BASIC_SUB]!! }
    ...
    suspend fun querySubscribeDetails() {
